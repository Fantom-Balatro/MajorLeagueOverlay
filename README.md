...
### Format
{ user = `<username>`, nemesis = `<username_opponent>`, action = "game_start", starting_lives = `<starting_lives>` }
### Example
{ user = "Fantom", nemesis = "oathkeep", action = "game_start", starting_lives = 4 }
